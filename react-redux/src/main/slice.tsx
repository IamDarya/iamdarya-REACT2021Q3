...
export const getArticles = (searchValueAPI: string,
sortByAPI: SortType,
amountArtclsPerPAgeAPI: number,
pageAPI: number,
clickSearchAPI: boolean) => async (dispatch: AppDispatch) => {
...
export const { changeValue, changeArticles, changeIsLoading, changeTotalResults } = mainComponentSlice.actions
